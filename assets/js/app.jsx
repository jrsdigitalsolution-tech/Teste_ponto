...
function App() {
    ...
    useEffect(() => {
        if (user?.perfil === PERFIL_ADMIN && aba === "analises" && !analises && !carregandoAnalises) {
            buscarAnalises();
        }
    }, [user, aba, analises, carregandoAnalises]);
...
function LoginPage({
    ...
    return (
        <main className="safe-page auth-page auth-page-modern">
            <section className="auth-shell">
                <aside className="auth-hero">
                    <div className="auth-hero-top">
                        <span className="brand-mark auth-brand-mark">⏱</span>
                        <span className="security-badge">ERP de Ponto</span>
                    </div>

                    <div className="auth-hero-content">
                        <p className="eyebrow">Controle profissional de jornada</p>
                        <h1>Gestão de ponto com visão de RH, análises e banco de horas.</h1>
                        <p>
                            Uma experiência mais moderna para registrar ponto, acompanhar equipes
                            e transformar dados de jornada em decisões operacionais.
                        </p>
                    </div>
                    ...
                    <div className="login-feature-list">
                        <div>
                            ...
                            <span>Acesso validado pela sua API.</span>
                        </div>
                        <div>
                            <strong>Responsivo</strong>
                            <span>Interface própria para PC e mobile.</span>
                        </div>
                        <div>
                            <strong>Gerencial</strong>
                            <span>Indicadores para RH e operação.</span>
                        </div>
                    </div>
                </aside>
                ...
                <section className="auth-card auth-panel">
                    <div className="auth-brand">
                        <span className="brand-mark d-lg-none">⏱</span>
                        <div>
                    ...
                    <form onSubmit={login}>
                        ...
                        <p className="login-helper">
                            O painel abre automaticamente após a confirmação da API.
                        </p>
                    </form>
                </section>
            </section>
...
function MobileLayout({
    ...
    return (
        <div className="mobile-shell">
            <header className="mobile-header">
                <div className="mobile-header-inner">
                    <div>
                        ...
                        <p className="mobile-subtitle">{isAdmin ? "RH, ponto e análises" : "Meu ponto"}</p>
                    </div>
            ...
            {isAdmin && (
                <nav className="mobile-tabs mobile-tabs-erp" aria-label="Navegação mobile">
                    <button
                        type="button"
