                ...
                <aside className="auth-hero">
                    <div className="auth-hero-top">
                        <div className="auth-logo-group">
                            ...
                            <div>
                                <strong>JR Digital Solution</strong>
                    ...
                    <div className="auth-hero-content">
                        ...
                        <h1>Seu ponto em uma experiência de ERP moderna, segura e objetiva.</h1>
                        <p>
                            Registre jornadas, acompanhe indicadores e mantenha a operação de RH organizada
                            em uma interface responsiva, clara e alinhada à identidade da sua marca.
                        </p>
                    </div>
                    ...
                    <div className="login-feature-list">
                        <div>
                            ...
                            <span>Logo e cores aplicadas em todo o sistema.</span>
                        </div>
                        <div>
                            <strong>ERP nativo</strong>
                            <span>Desktop em tela cheia com navegação operacional.</span>
                        </div>
                        <div>
